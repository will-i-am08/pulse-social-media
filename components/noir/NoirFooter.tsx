...
export default function NoirFooter({ climb = false }: { climb?: boolean }) {
  ...
  if (climb) {
    return (
      <div style={{ position: 'relative', zIndex: 5, borderTop: '1px solid rgba(236,230,216,0.08)' }}>
        <div style={{ maxWidth: 1240, margin: '0 auto', padding: '42px 40px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 18 }}>
  ...
  return (
    <div style={{ position: 'relative', zIndex: 5, borderTop: '1px solid rgba(255,255,255,0.06)' }}>
      <div style={{ maxWidth: 1240, margin: '0 auto', padding: '44px 40px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 18 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
        ...
        <div style={{ fontSize: 14, color: 'rgba(244,245,247,0.5)', fontWeight: 500 }}>
