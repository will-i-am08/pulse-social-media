    ...
    <footer className="bg-neutral-950 w-full pt-20 pb-10">
      <div className="max-w-7xl mx-auto px-8 flex flex-col md:flex-row justify-between items-center gap-8">
        <div className="flex flex-col items-center md:items-start gap-4">
          ...
          <p className="font-body text-xs uppercase tracking-widest text-rose-500 font-bold">The Emissary of Heat.</p>
        </div>
        ...
        <div className="text-neutral-600 font-body text-xs uppercase tracking-widest">© 2026 Pulse Digital Agency. All rights reserved.</div>
      </div>
    </footer>
  )
}
