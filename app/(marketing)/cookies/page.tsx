    ...
    <main className="pt-32 pb-20 px-6 max-w-4xl mx-auto">
      ...
      <AnimateOnScroll variant="fade-up" delay={0.1}>
        <div className="prose-custom space-y-10 text-[#6b7280] leading-relaxed">
          <section>
            <h2 className="text-xl font-bold text-[#0a0a0a] mb-3">1. What Are Cookies</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-[#0a0a0a] mb-3">2. How We Use Cookies</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-[#0a0a0a] mb-3">3. Types of Cookies</h2>
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li><strong className="text-[#0a0a0a]">Essential cookies:</strong> Required for basic site functionality and authentication.</li>
              <li><strong className="text-[#0a0a0a]">Analytics cookies:</strong> Help us understand site usage and improve our services.</li>
              <li><strong className="text-[#0a0a0a]">Preference cookies:</strong> Remember your settings like theme and language.</li>
            </ul>
          </section>

          <section>
            <h2 className="text-xl font-bold text-[#0a0a0a] mb-3">4. Managing Cookies</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-[#0a0a0a] mb-3">5. Contact</h2>
            <p>For questions about our cookie practices, contact us at <a href="mailto:hello@pulsedigital.agency" className="text-[#ff5473] hover:underline">hello@pulsedigital.agency</a>.</p>
          </section>
        </div>
      </AnimateOnScroll>
    </main>
