    ...
    <main className="pt-32 pb-20 overflow-hidden">
      ...
      <section className="max-w-7xl mx-auto px-8 mb-32">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          <AnimateOnScroll variant="fade-up" delay={0} className="md:col-span-8 bg-surface-container rounded-xl p-10 flex flex-col justify-between min-h-[420px] group overflow-hidden relative">
          ...
          {/* Calendar */}
          <AnimateOnScroll variant="fade-up" delay={0.15} className="md:col-span-4 bg-surface-container-low rounded-xl p-10 flex flex-col justify-between min-h-[340px]">
            <div>
          ...
          {/* Photo Library */}
          <AnimateOnScroll variant="fade-up" delay={0.2} className="md:col-span-4 bg-surface-container-low rounded-xl p-10 flex flex-col justify-between min-h-[340px]">
            <div>
          ...
          {/* Publishing */}
          <AnimateOnScroll variant="fade-up" delay={0.25} className="md:col-span-4 bg-surface-container rounded-xl p-10 flex flex-col justify-between min-h-[340px] group border border-outline-variant/10">
            <div>
          ...
          {/* Analytics */}
          <AnimateOnScroll variant="fade-up" delay={0.3} className="md:col-span-8 bg-surface-container rounded-xl p-10 flex flex-col md:flex-row gap-10 items-center overflow-hidden">
