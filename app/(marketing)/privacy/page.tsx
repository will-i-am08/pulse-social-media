    ...
    <main className="pt-32 pb-20 px-6 max-w-4xl mx-auto">
      ...
      <AnimateOnScroll variant="fade-up" delay={0.1}>
        <div className="prose-custom space-y-10 text-[#6b7280] leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-[#0a0a0a] mb-3">3. Data Sharing</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-[#0a0a0a] mb-3">4. Data Security</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-[#0a0a0a] mb-3">5. Your Rights</h2>
          ...
          <section>
            ...
            <p>If you have questions about this privacy policy, please contact us at <a href="mailto:hello@pulsedigital.agency" className="text-[#ff5473] hover:underline">hello@pulsedigital.agency</a>.</p>
          </section>
        </div>
      </AnimateOnScroll>
    </main>
