...
function rowToBrand(row: Record<string, unknown>): WorkspaceBrand {
  return {
    ...
    customRules: (row.custom_rules as WorkspaceBrand['customRules']) || [],
...
export async function PUT(req: NextRequest) {
  ...
  const fieldMap: Record<string, string> = {
    ...
    brandVoice: 'brand_voice', postingInstructions: 'posting_instructions', customRules: 'custom_rules', tone: 'tone', outputLength: 'output_length',
