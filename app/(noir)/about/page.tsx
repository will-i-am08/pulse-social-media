...
export default function AboutPage() {
  return (
    <>
      ...
      {/* hero */}
      <div style={{ position: 'relative', zIndex: 5, maxWidth: 880, margin: '0 auto', padding: '96px 40px 0', textAlign: 'center' }}>
        <div className="kicker" style={{ fontSize: 13, marginBottom: 18 }}>About Pulse</div>
        <h1 className="sora" style={{ fontWeight: 800, fontSize: 'clamp(52px,7vw,90px)', lineHeight: 1.0, letterSpacing: '-0.04em', margin: 0 }}>A small studio<br />for big voices.</h1>
      ...
      <div style={{ position: 'relative', zIndex: 5, maxWidth: 1100, margin: '64px auto 0', padding: '0 40px' }}>
      ...
      {/* origin story */}
      <div style={{ position: 'relative', zIndex: 5, maxWidth: 760, margin: '96px auto 0', padding: '0 40px' }}>
        ...
        <div style={{ marginTop: 56, padding: '40px 44px', borderRadius: 24, background: 'rgba(249,115,22,0.05)', borderLeft: '3px solid #F97316', borderTop: '1px solid rgba(249,115,22,0.14)', borderRight: '1px solid rgba(249,115,22,0.06)', borderBottom: '1px solid rgba(249,115,22,0.06)' }}>
      ...
      <div style={{ position: 'relative', zIndex: 5, maxWidth: 1240, margin: '0 auto', padding: '110px 40px 0' }}>
        <div style={{ textAlign: 'center', marginBottom: 48 }}>
          ...
          <h2 className="sora" style={{ fontWeight: 800, fontSize: 46, letterSpacing: '-0.03em', margin: 0 }}>Four rules we actually live by.</h2>
      ...
      <div style={{ position: 'relative', zIndex: 5, maxWidth: 1240, margin: '0 auto', padding: '110px 40px 0' }}>
        <div style={{ marginBottom: 48 }}>
          ...
          <h2 className="sora" style={{ fontWeight: 800, fontSize: 46, letterSpacing: '-0.03em', margin: 0, lineHeight: 1.06 }}>Why we do what we do.</h2>
        </div>
        <div style={{ borderRadius: 24, overflow: 'hidden', border: '1px solid rgba(255,255,255,0.07)' }}>
          {WHY.map(([kicker, head, body], i) => (
            <div key={kicker} className="grid-collapse" style={{ padding: '40px 48px', background: i % 2 === 0 ? 'rgba(255,255,255,0.03)' : 'rgba(13,15,17,0.6)', display: 'grid', gridTemplateColumns: '1fr 2fr', gap: 48, alignItems: 'start', borderTop: i === 0 ? 'none' : '1px solid rgba(255,255,255,0.05)' }}>
              <div>
              ...
              <p style={{ fontSize: 17, color: 'rgba(244,245,247,0.68)', lineHeight: 1.65, fontWeight: 500, margin: 0, paddingTop: 28 }}>{body}</p>
            </div>
          ))}
        </div>
      </div>
      ...
      {/* CTA */}
      <div style={{ position: 'relative', zIndex: 5, maxWidth: 880, margin: '110px auto 0', padding: '0 40px 90px' }}>
        <div style={{ borderRadius: 28, padding: 1, background: 'linear-gradient(160deg,rgba(249,115,22,0.4),rgba(255,255,255,0.02))', boxShadow: '0 40px 120px rgba(0,0,0,0.55)' }}>
          <div style={{ borderRadius: 27, background: 'rgba(13,15,17,0.74)', backdropFilter: 'blur(26px)', padding: 60, textAlign: 'center' }}>
            <div className="kicker" style={{ fontSize: 13, marginBottom: 14 }}>Work with us</div>
            <h2 className="sora" style={{ fontWeight: 800, fontSize: 44, letterSpacing: '-0.03em', margin: '0 0 18px', lineHeight: 1.06 }}>Let&apos;s make something.</h2>
